...
const testimonials = [
    ...
    },
    {
        ...
        quote: "I love how clean the interface is. Most financial apps are cluttered and confusing, but NovaMint keeps things focused. The early access cards were a huge help for my startup in the early days. Highly recommend to any growing team.",
        author: "Guy Hawkins",
